...
db=mysql.connector.connect(user="root",passwd="mughal123",host="localhost") 
...
db=mysql.connector.connect(user="root",passwd="mughal123",host="localhost",database='Shop') 
my_cursor=db.cursor()
...
def addProd(): 
    ...
    #Creating the window
    wn = tkinter.Tk() 
    wn.title("Online Store Management System")
...
headingFrame1.place(relx=0.2,rely=0.1,relwidth=0.6,relheight=0.16)
headingLabel = Label(headingFrame1, text="Welcome to Online Store \n Management System", fg='grey19', font=('Courier',15,'bold'))
headingLabel.place(relx=0,rely=0, relwidth=1, relheight=1)
